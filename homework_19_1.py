...
<main>
    ...
    <div class="container">
        ...
        <div class="row text-center">
        <div class="col-12">
            <div class="card mb-3 rounded-6 shadow-sm">
                <p>FAQ</p>
                <p class="d-inline-flex gap-1">
                      <div class="w-100 p-3" style="background-color: #eee;">
                          ...
                          <button class="btn btn-primary" type="button" data-bs-toggle="collapse" data-bs-target="#multiCollapseExample3" aria-expanded="false" aria-controls="multiCollapseExample1 multiCollapseExample2">Какая гарантия</button>
                      </div>
                </p>
                <div class="row" >
                  <div class="col">
